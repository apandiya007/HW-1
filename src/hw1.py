...
class TestHousingQuestionAsker(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=['3', 'y', '15', 'y', 'n'])
    def test_return_types(self, mock_input: MagicMock) -> None:
        """Test that all methods return the correct data types."""
        # TODO: Test that methods return correct types
        # This test verifies your type hints are implemented correctly
        pass
