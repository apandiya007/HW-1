...
class TestHousingQuestionAsker(unittest.TestCase):
    ...
    def test_ask_class_year_valid_input(self, mock_input):
    ...
    def test_ask_class_year_invalid_then_valid(self, mock_input):
    ...
    def test_ask_graduation_status_yes(self, mock_input):
        """TODO: Test ask_graduation_status with 'y' input."""
        # TODO: Test that the method returns True for 'y'
        pass

    @patch('builtins.input', return_value='n')
    def test_ask_graduation_status_no(self, mock_input):
    ...
    def test_ask_additional_questions_with_invalid_input(self, mock_input):
