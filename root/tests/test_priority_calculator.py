...
class TestHousingPriorityCalculator(unittest.TestCase):
    ...
    def test_points_for_class_year_freshman(self):
    ...
    def test_calculate_total_score_senior_graduating_scenario(self):
    ...
    def test_calculate_total_score_senior_non_graduating_scenario(self):
    ...
    def test_calculate_total_score_edge_cases(self):
